...
def generate_section_grid(region='Amundsen'):
   ...
   if ( region == 'Amundsen' ):
     longitude=np.array([-101.847133917121, -102.055613197435, -102.264092477749, -102.472571758063, -102.681051038377, -102.889530318691, 
     ...
     latitude=np.arange(-75.1+1./30.,-70.0+1./30.,1./30.) 
